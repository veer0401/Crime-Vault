...
$(document).ready(function () {
    var loginSuccess = $("#loginSuccessFlag").val();
    if (loginSuccess === "True") {
        toastr.success("Login successful!", "Welcome Back!", { timeOut: 3000 });
    } else if (loginSuccess === "False") {
        toastr.error("Login failed! Please check your credentials.", "Error", { timeOut: 3000 });
    }
});
